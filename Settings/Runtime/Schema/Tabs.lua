...
contentTabs = {
        { id = 'jukebox', name = 'Jukebox', labelVariable = 'Loc_Settings_Content_Jukebox', fields = { 'jukeboxEnabled', 'jukeboxHelp', 'jukeboxPlaybackSourceMode', 'jukebox2DMode', 'jukeboxDisableNoteAnimation', 'jukeboxDraggable', 'jukeboxDragSnap' } },
