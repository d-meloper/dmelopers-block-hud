...
local function isWorkProgressEnabled(SKIN)     return trim(SKIN:GetVariable('EnableWorkProgress', '1')) ~= '0' end  local function getInventoryMetrics(SKIN, scale)
    ...
    local height = round(INVENTORY_DESIGN_HEIGHT * scale)
    ...
    return {
        width = width,
        height = height,
        slotSize = round(INVENTORY_DESIGN_SLOT_SIZE * scale),
        gridOffsetX = round(INVENTORY_DESIGN_GRID_OFFSET_X * scale),
        gridOffsetY = round(INVENTORY_DESIGN_GRID_OFFSET_Y * scale),
